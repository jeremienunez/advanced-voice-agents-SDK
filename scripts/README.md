...
- `audits/` contains architecture, dependency, responsibility, LOC, public API, SDK type-domain, SDK type-import, SDK-boundary, tool-contract, and secret-hygiene audits.
