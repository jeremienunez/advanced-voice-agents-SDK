...
- `index.ts` is the stable `@voiceagentsdk/core/server` facade.
...
Keep concrete provider and transport details here. Shared, provider-neutral contracts belong in `src/sdk/types/`.
